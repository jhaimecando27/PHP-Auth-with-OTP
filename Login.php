...
<h2 style="color: white; text-align: center; font-size: 50px;">Login</h2>
...
<input style="color: white; font-size: 15px;" type="checkbox" name="remember"> Forgot Password <br><br>
